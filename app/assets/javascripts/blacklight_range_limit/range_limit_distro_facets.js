    ...
    function areaChart(container) {
      ...
      if (  domDependenciesMet()  ) {
        ...
        $(container).find("ul li").each(function() {
            var from = parseInt(stripNonNumeric($(this).find("span.from").text()));
            var to = parseInt(stripNonNumeric($(this).find("span.to").text()));
            var count = parseInt(stripNonNumeric($(this).find("span.count").text()));
